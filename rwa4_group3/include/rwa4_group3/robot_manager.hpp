...
class RobotManager : public rclcpp::Node
{
    ...
    public:
        ...
        void FloorRobotPickPart(geometry_msgs::msg::Pose pose);
         ...
         * @param msg 
         */
        void robot_task_callback(const rwa4_group3::msg::RobotTask::SharedPtr msg);
    ...
    private:
        ...
        rclcpp::Subscription<rwa4_group3::msg::RobotTask>::SharedPtr robot_task_subscription_;
        ...
        rwa4_group3::msg::RobotTask current_task_;
